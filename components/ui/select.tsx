...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        'flex w-full h-12 items-center justify-between gap-2 rounded-md border border-[var(--input-border)] bg-white px-3 text-sm sm:text-[16px] text-[var(--input-placeholder)] transition-colors',
        'hover:border-[var(--input-ring)]',
        'outline-none focus:outline-none focus-visible:outline-none focus:ring-1 focus:ring-[var(--input-ring)]',
